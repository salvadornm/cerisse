...
# Geometry
Diameter_Cone  = 0.127;              # forebody cone diameter/m
Radius_Cone    = 0.5*Diameter_Cone;  # forebody cone radius/m
Theta_Cone_Deg = 70.0;               # forebody cone apex angle/deg
Len_Aftbody    = 0.24257;            #  aftbody cylinder length/m
Nz_Exit_To_Geo = 0.1;                # ratio of nozzle exit diameter to forebody cone diameter

Height_Cone    = Radius_Cone/tan(Theta_Cone_Deg*pi/180);  # forebody cone height/m


print(" -----------  Geometry parameters  -----------")
print("Diameter_Cone =", Diameter_Cone, "[m]")
print("Radius_Cone =", Radius_Cone, "[m]")
print("Theta_Cone_Deg =", Theta_Cone_Deg, "[degrees]")
print("Len_Aftbody =", Len_Aftbody, "[m]")
print("Nz_Exit_To_Geo =", Nz_Exit_To_Geo)
print("Height_Cone =", Height_Cone, "[m]")
print(" for cerisse prob.h file (copy the  C++ lines below):")
print(" static constexpr Real Height_Cone  = ", Height_Cone, ";")
