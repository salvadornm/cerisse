...
void Custom::build(const Geometry& geom, const int max_coarsening_level)
{
  ...
  const Real z0atmo =  0.1775; //0.1675; 
  ...
  // new adding atmosphere
  auto cchamber_with_injector2 =  EB2::DifferenceIF<EB2::DifferenceIF<EB2::CylinderIF, EB2::CylinderIF>, EB2::CylinderIF>(cchamber_with_injector,atmo);
