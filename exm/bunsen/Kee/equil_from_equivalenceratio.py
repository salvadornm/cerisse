...
# phases
gas = ct.Solution('Kee.yaml')

# the phases that will be included in the calculation, and their initial moles
mix_phases = [(gas, 1.0)]

# fuel annd opxidizer
fuel_species = 'H2:0.875, CH4:0.125' # per volume (molar fractions)
air = "O2:0.21,N2:0.79"              # per volume (molar fractions)
...
# set the gas state
gas.set_equivalence_ratio(phi, fuel_species, air)
