...
fuelmix = 'H2:0.875, CH4:0.125' # per volume (molar fractions)
oxidizer= "O2:0.21,N2:0.79"              # per volume (molar fractions)
...
gas.set_equivalence_ratio(phi, fuelmix, oxidizer)
