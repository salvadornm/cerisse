...
int       CNS::refine_max_pressgrad_lev = -1;

Real      CNS::refine_dengrad           = 1.0e10;
Real      CNS::refine_pressgrad          = 1.0e10;
...
#pragma omp parallel
    ...
    //  SNM : refine based on Pressure  ??
    // const auto& rho = derive("pressure", time, ng);
...
CNS::read_params ()
{
    ...
    pp.query("refine_max_pressgrad_lev", refine_max_pressgrad_lev);        
    pp.query("refine_pressgrad", refine_pressgrad);
