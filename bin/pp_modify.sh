...
FILE="../lib/PelePhysics/Reactions/ReactorCvodeUtils.cpp"
sed -i '16{
  s|^[[:space:]]*//|//|;       # Keep already-commented lines as is
  t done
  s|^|//|
...
FILE="../lib/PelePhysics/Reactions/ReactorCvode.cpp"
...
FILE="../lib/PelePhysics/Reactions/ReactorCvodePreconditioner.cpp"
