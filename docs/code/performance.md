---
description: Scaling in HPC systems
icon: gauge-max
---
...
_Strong scaling_ refers to how the solution time decreases as more cores\
are used for a fixed total problem size.

_Architecture_\
Single node AMD Rome EPYC 7742 up to 128 cores\
&#xNAN;_&#x53;oftware Modules_
...
The test case is a TGV 128 x 128 x 128, Mach=1.25, Re=1600, with fix CFL=0.3 using TENO5

<figure><img src="../.gitbook/assets/MPI.png" alt=""><figcaption><p>Strong scaling test on a single node up to 128 cores</p></figcaption></figure>

### Performance Table

| # cores | Runtime Advance \[s] | Speedup | Efficiency |   Min |   Avg |   Max | % Advance | % Load-Imbalance |
| :-----: | -------------------: | ------: | ---------: | ----: | ----: | ----: | --------: | ---------------: |
...
Same as single-node scaling but with different \
&#xNAN;_&#x53;oftware Modules_
...
| # cores (Nodes) | Runtime Advance \[s] | Speedup | Efficiency |  Min |  Avg |  Max | % Advance | % Load-Imbalance |
| :-------------: | -------------------: | ------: | ---------: | ---: | ---: | ---: | --------: | ---------------: |
|     128 (1)     |              4145.96 |   1.000 |      1.000 | 2808 | 2865 | 3099 |    74.75% |           10.16% |
|     256 (2)     |              1443.20 |   2.873 |      1.436 | 9776 | 9779 | 9782 |    79.06% |            6.06% |
|     384 (3)     |             1573.697 |   2.634 |      0.878 |  512 |  690 |  833 |    52.95% |           46.44% |
|     512 (4)     |              724.026 |   5.726 |      1.432 |  523 |  534 |  543 |    75.01% |            3.74% |

## Weak scaling ARCHER2

In _Weak scaling_ the problem size and the number of cores increases, so that each cores handles the same amount of work.

The test case is a TGV Mach=1.25, Re=1600, with fix CFL=0.3 using TENO5.\
...
_Software Modules_`PrgEnv-gnu` environment, check [ARCHER2 documentation](https://docs.archer2.ac.uk/user-guide/dev-environment/)
