...
// Old WENO-EB code, to be updated and cleaned up.
// to be used with EB, without EWB or IBM used Weno_t instead
//
...
class wenoEB_t {
 ...
 public:
  ...
  AMREX_GPU_DEVICE AMREX_FORCE_INLINE bool fill_solid_prims(
      ...
      const amrex::Array4<uint8_t>& ib_mask) {
